...
static constexpr const unsigned float BaseDamage_METAL_PICK = 34.3;
...
static constexpr const unsigned float BaseTorpor_SLINGSHOT = 23.8;
...
static constexpr const unsigned float DotTorpor_CROSSBOW_TRANQ_ARROW = 87.5;  //over 4 seconds - doesn't stack
...
//static constexpr const unsigned float DotTorpor_LONGNECK_RIFLE_DART = BaseTorpor_LONGNECK_RIFLE_DART * 2.5; //over 5 seconds - stacks 5s time per shot
...
static constexpr const unsigned float BaseDamage_ASSAULT_RIFLE = 59.4;
